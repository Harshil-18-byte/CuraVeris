...
import { ChevronDown, ChevronUp, Download, Info, ShieldAlert } from "lucide-react";
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-neutral-300 text-sm font-body">
            ...
            <tr className="bg-neutral-50 font-bold">
              <td colSpan={5} className="py-4 px-4 text-neutral-900 text-right uppercase text-xs tracking-wider">
