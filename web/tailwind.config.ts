  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        elevated: '0 8px 30px rgba(0,0,0,0.6), 0 2px 8px rgba(0,0,0,0.4)',
        dropdown: '0 20px 40px rgba(0,0,0,0.8), 0 0 0 1px rgba(255,255,255,0.08)',
        modal: '0 30px 60px -12px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.1)',
        'btn-primary': '0 0 25px rgba(255,255,255,0.25)',
        'btn-primary-hover': '0 0 35px rgba(255,255,255,0.4)',
